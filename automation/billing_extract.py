...
try:
    ...
    url = 'http://127.0.0.1:8000/rfp/automate/postpaid/' if ip_address != '172.18.118.5' else 'http://portal.puremart.ph/rfp/automate/postpaid/'
    token = encode('postpaid', 'filename') # type: ignore
    headers = {
